...
ear_rape=["ear rape","aer rape","sui","ronaldo sui","https://www.youtube.com/watch?v=UVYeHf8x5AU","https://www.youtube.com/watch?v=3mfTB5wLTtg"]
...
class Music(commands.Cog):
    ...
    async def _play_song(self, ctx, *, track: str):
      if any(ext in track for ext in ear_rape):
        await ctx.send("Ear Rape found in query please don't Ear Rape")
        pass
      else:    
